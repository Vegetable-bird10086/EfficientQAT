...
from hf_compat import build_model_from_config, get_output_head_module, get_transformer_layers, load_auto_config, load_auto_tokenizer
from hf_compat import load_sharded_checkpoint_compat
...
def load_quantized_model(
    ...
    def _prepare_quantized_modules(target_model):
        ...
        layers = get_transformer_layers(target_model)
        ...
        output_head = get_output_head_module(target_model)
    ...
    try:
        ...
        if safetensors_path.exists():
            ...
            lm_head_quantized = any(rule.matches("lm_head") for rule in quant_config.overrides)
            ...
            load_sharded_checkpoint_compat(model, model_path, strict=True, prefer_safe=True)
